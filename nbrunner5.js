...
function makeMenu() {
    ...
    $("head").first().append('<link rel="stylesheet" href="../nbplayer.css"'), $("body").first().append('<script src="custom.js"><\/script>');
...
const iconDictionary = {
    ...
    addAbove: `<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
        ...
        <path fill-rule="evenodd" clip-rule="evenodd" d="M2.5 8.5V10.5H11.5V8.5H2.5ZM2 7C1.44772 7 1 7.44772 1 8V11C1 11.5523 1.44772 12 2 12H12C12.5523 12 13 11.5523 13 11V8C13 7.44771 12.5523 7 12 7H2Z" fill="#616161"/>
    </svg>`,
...
function addControlBar(cell) {
	...
	if (cell.classList.contains('nb-code-cell')) {
		...
		// Add Preview button for markdown cells
